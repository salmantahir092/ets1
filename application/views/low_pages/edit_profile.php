    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="javascript:history.back(1)">Employee Info</a></li>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="box-group">
                                ...
                                <form action="edit_employee" class="text-bold" method="POST">
                                    <p style="margin-top: 10px">Name </p>
                                    <input type="hidden" name="id" value="<?php echo $user_info['emp_id']; ?>"/>
                                    <input type="hidden" name="add_id" value="<?php echo $user_info['address_id']; ?>"/>
                                    <input name="name"
                                           style="margin-top: 10px; margin-bottom: 10px; width: 25%"
                                           type="text"
                                           class="form-control text-uppercase"
                                           value="<?php echo $user_info['emp_name']; ?>"
                                           required="true"/>
                                    ...
                                    <input name="designation"
                                           ...
                                           type="text"
                                           class="form-control"
                                           value="<?php echo $user_info['role_designation']; ?>"
                                           required="true"/>
                                    ...
                                    <input name="add_area"
                                           ...
                                           type="text"
                                           class="form-control"
                                           value="<?php echo $user_info['address_area']; ?>"
                                           required="true"/>
                                    ...
                                    <input name="add_city"
                                           ...
                                           type="text"
                                           class="form-control"
                                           value="<?php echo $user_info['address_city']; ?>"
                                           required="true"/>
