        ...
        <section class="content-header">
            ...
            <div class="box-tools pull-right">
                <form action="view_orders" method="POST">
                    <select name="month">
                        <option value="0" selected="selected">Select Month
                        </option>
                        <option value="1">Jan
                        </option>
                        <option value="2">Feb
                    ...
                    <select name="year">
                        <option value="0" selected="selected">Select Year
                        </option>
                        <?php $range = $year - 1990;
                        for ($i = 0; $i <= $range; $i++) {
                            $curyear = $year - $i; ?>
                            <option value="<?php echo $curyear ?>"><?php echo $curyear ?>
                            </option>
                        <?php } ?>
                    </select>
