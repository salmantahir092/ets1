                                    ...
                                    <?php foreach ($users_emp as $row) { ?>
                                        <li>
                                            <a class="users-list-name"
                                               href="<?php echo base_url(); ?>index.php/dashboardmed/view_profile?id=<?php echo $row['emp_id']; ?>">
                                                <img class="img-circle" src="<?php echo $row['emp_dp']; ?>" alt="User Image" width="100" height="100"></a>
                                            <a class="users-list-name"
                                               href="<?php echo base_url(); ?>index.php/dashboardmed/view_profile?id=<?php echo $row['emp_id']; ?>"><?php echo $row['emp_name']; ?></a>
                                                    <span
