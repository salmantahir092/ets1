            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="box-group text-bold">
<!--                                <div class="pull-right">-->
<!--                                    <a href="edit_me" class="btn btn-default btn-flat text-blue"> Edit </a>-->
<!--                                </div>-->
                                <img src="<?php echo $admin_info['emp_dp']; ?>" class="img-circle profile-pic-full"
                                     alt="User Image">

                                <p>Name </p>

                                <h3 class="text-uppercase"
                                    style="margin-top: 10px"><?php echo $admin_info['emp_name']; ?></h3>

                                <p>Email</p>

                                <h3 class="text" style="margin-top: 10px"><?php echo $admin_info['email']; ?></h3>

                                <p>Designation </p>

                                <h3 class="text"
                                    style="margin-top: 10px"><?php echo $admin_info['role_designation']; ?></h3>

                                <p>Phone </p>

                                <h3 class="text" style="margin-top: 10px"><?php echo $admin_info['phone_no']; ?></h3>

                                <p>Address </p>

                                <h3 class="text-uppercase"
                                    style="margin-top: 10px"><?php echo $admin_info['address']; ?></h3>

                                <p>Join Date</p>

                                <h3 class="text" style="margin-top: 10px"><?php echo $admin_info['join_date']; ?></h3>
                            </div>
