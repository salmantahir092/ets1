            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="box-group">
                                <!--                            <input type="text" name="browse-profile-pic"-->
                                <!--                                   value=""/>-->

                                <div id="profile-pic-upload" class="profile-pic-full entry-wrapper" title="">
                                    <label>
                                        <input type="file" id="profile-pic-input">
                                        <img class="img-circle profile-pic-full"
                                             src="<?php echo $admin_info['emp_dp']; ?>"  alt="User Image"/>
                                    </label>
                                </div>
                                <script type="text/javascript">
                                    $('#profile-pic-input').on('change', function () {
                                        ...
                                        alert("url : " + filePath.name);


//                                    lastModified:1473821421313
//                                    lastModifiedDate:Wed Sep 14 2016 07:50:21 GMT+0500 (Pakistan Standard Time)
//                                    name:"5.jpg"
//                                    size:289938
//                                    type:"image/jpeg"
//                                    webkitRelativePath:""
                                ...
                                <form action="edit_admin" class="text-bold" method="POST">
