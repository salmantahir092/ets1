                        ...
                        <div class="col-md-12 col-sm-8">
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title text-bold">Region Managers</h3>
                                            ...
                                            <?php foreach ($users as $row) { ?>
                                                <li>
                                                    <a class="users-list-name"
                                                       href="<?php echo base_url(); ?>index.php/dashboardhigh/view_employee_region?id=<?php echo $row['emp_id']; ?>">
                                                        <img class="img-circle" src="<?php echo $row['emp_dp']; ?>" alt="User Image" width="100" height="100"></a>
                                                    <a class="users-list-name"
                                                       href="<?php echo base_url(); ?>index.php/dashboardhigh/view_employee_region?id=<?php echo $row['emp_id']; ?>"><?php echo $row['emp_name']; ?></a>
                                                    <span
