                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    <div class="box-group">
                                        ...
                                        <p>Status </p>
                                        <?php if ($user_info['emp_status'] == 'on duty') { ?><h3
                                            class="label label-success">On
                                            Duty</h3><?php } ?>
                                        <?php if ($user_info['emp_status'] == 'off duty') { ?><h3
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <script type="text/javascript">
                            function refreshOrders(month) {
                                window.location = "<?php echo base_url(); ?>index.php/dashboardhigh/view_profile?id=<?php echo $user_info['emp_id']; ?>&month=" + month;
                            }
                        </script>
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        </button>
