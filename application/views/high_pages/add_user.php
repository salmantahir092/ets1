    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Region Manager</li>
            </ol>
        </section>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="box-group">
                                ...
                                <form action="add_user_db" class="text-bold" method="POST">
                                    <input type="hidden" name="sup_id" value="<?php echo $admin_id; ?>"/>
