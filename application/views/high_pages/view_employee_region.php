...
<head>
    ...
    <title>ETS | Region Manager</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Region Manager</li>
            </ol>
        </section>
...
<!--                                               class="btn btn-flat label-danger"> Delete </a>-->
<!--                                        </div>-->
                                        <div class="pull-left">
                                            <a href="<?php echo base_url(); ?>index.php/dashboardhigh/delete_profile?id=<?php echo $user_info['emp_id']; ?>"
                                               onclick="return deletechecked();">
                        ...
                        <div class="col-md-12 col-sm-8">
                            <div class="pad">
                                <ul class="users-list clearfix">
                                    <?php foreach ($users_area as $row) { ?>
                                        <li>
                                            <a class="users-list-name"
                                               href="<?php echo base_url(); ?>index.php/dashboardhigh/view_employee_area?id=<?php echo $row['emp_id']; ?>">
                                                <img class="img-circle "src="<?php echo $row['emp_dp']; ?>" alt="User Image" width="100" height="100"></a>
                                            <a class="users-list-name"
                                               href="<?php echo base_url(); ?>index.php/dashboardhigh/view_employee_area?id=<?php echo $row['emp_id']; ?>"><?php echo $row['emp_name']; ?></a>
                                                    <span
...
<!--                                                <img src="--><?php //echo $row['emp_dp']; ?><!--" alt="User Image"></a>-->
<!--                                            <a class="users-list-name"-->
