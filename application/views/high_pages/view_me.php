                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="box-group text-bold">
                                <img class="img-circle profile-pic-full" src="<?php echo $admin_info['emp_dp']; ?>" class="img-circle" alt="User Image">
                                ...
                                <h3 class="text-uppercase" style="margin-top: 10px"><?php echo $admin_info['address']; ?></h3>
